...
with st.sidebar.form("bookmark_form"):
    ...
    add_button = st.form_submit_button("추가하기")  # ✅ 필수 Submit 버튼!
...
with st.sidebar.form("delete_form"):
    ...
    if bookmark_names:
        ...
        delete_button = st.form_submit_button("삭제하기")  # ✅ 필수 Submit 버튼!
        if delete_button:
